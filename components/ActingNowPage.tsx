...
export const ActingNowPage: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                ...
                >
                    <div className="w-full aspect-[4/5] bg-white border-2 border-black rounded-[30px] flex items-center justify-center p-8 mb-8 relative group-hover:scale-[1.02] transition-transform">
                    ...
                    <SketchyButton 
                        ...
                        onClick={(e) => {
                            e.stopPropagation();
                            handleRedirect(twitterIntentUrl);
                        }}
                    >
                        Post for BUIDL
                    </SketchyButton>
                ...
                >
                    ...
                    <SketchyButton 
                        ...
                        onClick={(e) => {
                            e.stopPropagation();
                            handleRedirect(cafeCoBuildingUrl);
                        }}
                    >
